...
PROMPTS = {
    ...
    "host-property-management": "Build a complete host dashboard using wanderbricks. Let hosts see all their properties, upcoming bookings, recent reviews, and revenue metrics in one place. Different hosts have different priorities - some care about revenue, some about ratings, some about occupancy. The dashboard should somehow surface what matters most to each host type without being overwhelming. Think about information hierarchy.",
